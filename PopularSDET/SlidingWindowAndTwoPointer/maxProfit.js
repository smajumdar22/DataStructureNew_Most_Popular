...
function maxProfit(prices) {
  ...
  for (let price of prices) {
    if (price < minPrice) {
      minPrice = price; // Buy at lowest price seen so far
    } else {
...
// Example usage for no profit case:
const pricesNoProfit = [7, 6, 4, 3, 1];
const resultNoProfit = maxProfit(pricesNoProfit);
console.log(resultNoProfit); // Output: 0